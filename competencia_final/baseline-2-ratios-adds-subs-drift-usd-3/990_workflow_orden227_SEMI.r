...
FEintra_manual_base <- function( pinputexps )
{
  ...
  param_local$meta$script <- "/competencia_final/baseline-2-ratios-adds-subs-drift-usd-3/1301_FE_intrames_manual.r"
...
DR_drifting_base <- function( pinputexps, metodo)
{
  ...
  param_local$meta$script <- "/competencia_final/baseline-2-ratios-adds-subs-drift-usd-3/1401_DR_corregir_drifting.r"
...
DR_drifting_base2 <- function( pinputexps, metodo)
{
  ...
  param_local$meta$script <- "/competencia_final/baseline-2-ratios-adds-subs-drift-usd-3/1401_DR_corregir_drifting2.r"
