...
envg$EXPENV$semilla_primigenia <- 849991
...
FEintra_manual_base <- function( pinputexps )
{
  ...
  param_local$meta$script <- "/competencia_final/baseline-2-ratios-adds-subs-drift-usd-2/1301_FE_intrames_manual.r"
...
DR_drifting_base <- function( pinputexps, metodo)
{
  ...
  param_local$meta$script <- "/competencia_final/baseline-2-ratios-adds-subs-drift-usd-2/1401_DR_corregir_drifting.r"
...
DR_drifting_base2 <- function( pinputexps, metodo)
{
  if( -1 == (param_local <- exp_init())$resultado ) return( 0 ) # linea fija


  param_local$meta$script <- "/competencia_final/baseline-2-ratios-adds-subs-drift-usd-2/1401_DR_corregir_drifting2.r"
...
wf_SEMI2_ago_orden227 <- function( pnombrewf )
{
  ...
  DT_incorporar_dataset( "~/buckets/b1/datasets/competencia_3.csv.gz")

  CA_catastrophe_base( metodo="MachineLearning")
  DR_drifting_base(metodo="UVA")
  FEintra_manual_base()
  FEhist_base()
  DR_drifting_base2(metodo='rank_cero_fijo')
  ...
  ht <- HT_tuning_semillerio(
    semillerio = 75, # semillerio dentro de la Bayesian Optim
